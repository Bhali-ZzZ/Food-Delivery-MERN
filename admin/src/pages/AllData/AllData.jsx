...
const AllData = () => {
    ...
    const foodData = async () => {
        try {
            const response = await axios.get("https://food-b-backend.onrender.com/api/alldata/fooddata");
    ...
    const userData = async () => {
        try {
            const response2 = await axios.get("https://food-b-backend.onrender.com/api/alldata/userdata");
    ...
    const orderData = async () => {
        try {
            const response3 = await axios.get("https://food-b-backend.onrender.com/api/alldata/orderdata");
